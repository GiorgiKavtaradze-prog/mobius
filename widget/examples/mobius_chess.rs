...
impl MobiusChessApp {
    fn new() -> io::Result<Self> {
        MobiusGraphic::clear_all()?;

        let scene = MobiusGraphic::new(
            MobiusGraphicSettings::new(String::from("mobius_chess.obj"))
                .id(1)
                .normalize(false)
                .animate(false),
        );
...
impl MeshBuilder {
    fn new() -> Self {
        Self {
            obj: String::from("# mobius-mobius-chess\n"),
            v_idx: 1,
            vn_idx: 1,
        }
    }
