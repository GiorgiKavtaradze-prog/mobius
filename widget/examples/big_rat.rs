...
use ratatui_mobius::{MobiusGraphic, MobiusGraphicSettings};
...
impl CameraPreset {
    ...
    fn apply(self) -> io::Result<()> {
        let sequence = match self {
            Self::Flat => "\x1b_mobius;g;c;id=0;set=1;type=Flat\x1b\\".to_string(),
            Self::Ortho => {
                "\x1b_mobius;g;c;id=0;set=1;type=Ortho;scale=0.95;rx=8;ry=18;rz=2\x1b\\".to_string()
            }
            Self::Perspective => {
                "\x1b_mobius;g;c;id=0;set=1;type=Persp;fov=50;pz=40;rx=10;ry=20;rz=2\x1b\\"
                    .to_string()
            }
            Self::Mobius => {
                "\x1b_mobius;g;c;id=0;set=1;type=Mobius;scale=0.9;rx=12;ry=24;rz=4\x1b\\"
                    .to_string()
            }
        };
