//! Mobius Graphics Protocol parsing.
...
/// Mobius Graphics Protocol APC prefix.
pub const RGP_APC_START: &[u8] = b"\x1b_mobius;g;";
const ST: &[u8] = b"\x1b\\";
const C1_ST: u8 = 0x9c;
...
pub fn support_reply() -> Vec<u8> {
    b"\x1b_mobius;g;s;v=1;fmt=obj|glb|stl;path=1;payload=1;chunk=1;anim=1;depth=1;color=1;brightness=1;transform=1;update=1;normalize=1;camera=1\x1b\\".to_vec()
}
...
mod camera_tests {
    ...
    fn parse(fields: &str) -> RgpOperation {
        let sequence = format!("\x1b_mobius;g;c;{fields}\x1b\\");
